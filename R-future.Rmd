Parallel Processing using R's future package
=================================================================
...
(Note that the code here is not safe in terms of parallel randon number generation - see Section 8.)
...
```{r, off-load, fig.cap = '', fig.width=5, fig.height=5}
...
R worker processes with the same state as the original R process.
  ...
  - So **the additional processes do not use additional memory for those objects** (despite what is shown in *top*).
